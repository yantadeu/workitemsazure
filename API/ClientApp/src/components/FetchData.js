    ...
    return (
      <div>
        ...
        <p>Este; componente; exibe as informacoes; do banco; de; dados; alimentado; pela; API; do Azure</p>
            <Toolbar; className='clearfix'; style={;{ '1px solid #e0e0e0', backgroudColor;: "#ccc", display;: "flex", flexDirection;: "row", justifyContent;: "space-between", alignItems;: "center" }}>
                <div; style={;{ "flex", flex;: 1, flexDirection;: "row", justifyContent;: "space-between", alignItems;: "center" }}>
                    <div; style={;{ "flex", flex;: 1 }}>
                        <Input; style={;{ "flex", flex;: 1, fontSize;: 18 }} value={this.state.filter}; placeholder="Filtrar por tipo"; onChange={this.updateInputValue}; />
                    </div>
                    <div; style={;{ "flex", flexDirection;: "row", justifyContent;: "space-between", alignItems;: "center" }}>
